...
export function WaterManagement({ cropType, soilType, landArea, landAreaUnit, rainfall, t }: WaterManagementProps) {
  ...
  useEffect(() => {
    if (cropType && soilType) {
      ...
      setTimeout(() => {
        ...
        const getWaterData = (crop: string, soil: string, rain: number): WaterData => {
              ...
              <TabsContent value="overview" className="space-y-4 pt-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 border rounded-lg flex flex-col items-center justify-center">
                    ...
                    <div className={`text-3xl font-bold mb-2 ${waterData.currentWaterBalance < 0 ? 'text-red-500' : 'text-green-500'}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div className="flex items-center gap-2">
                          <Progress 
                            value={
                              soilType === "clayey" ? 90 : 
                              soilType === "black" ? 80 : 
                              soilType === "alluvial" ? 60 : 
                              soilType === "red" ? 50 : 
                              soilType === "sandy" ? 30 : 60
                            } 
                            className="h-2 flex-1" 
                          />
                          <span className="text-sm">
                            {soilType === "clayey" || soilType === "black" ? "High" : 
                             soilType === "alluvial" ? "Medium" : 
                             "Low"}
                          </span>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <Progress 
                            value={
                              cropType === "rice" || cropType === "sugarcane" ? 90 : 
                              cropType === "tomato" || cropType === "onion" ? 80 : 
                              cropType === "wheat" || cropType === "maize" ? 60 : 
                              cropType === "cotton" ? 40 : 70
                            } 
                            className="h-2 flex-1" 
                          />
                          <span className="text-sm">
                            {cropType === "rice" || cropType === "sugarcane" ? "High" : 
                             cropType === "tomato" || cropType === "onion" ? "High" : 
                             cropType === "wheat" || cropType === "maize" ? "Medium" : 
                             cropType === "cotton" ? "Low" : "Medium"}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={setIrrigationSystem}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 border rounded-lg">
                    ...
                    <div className="mt-4 p-3 bg-muted/50 rounded-lg">
                      <p className="text-sm text-muted-foreground">
                        Upgrading from flood to drip irrigation can save up to 40% of water while improving crop yields through more precise water application.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            For every 100 m² of collection area, you can harvest approximately 1 m³ of water per 10 mm of rainfall.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Consider installing storage tanks or creating farm ponds to store rainwater for use during dry periods.
                          </p>
                        </div>
                      </div>
                    </div>
